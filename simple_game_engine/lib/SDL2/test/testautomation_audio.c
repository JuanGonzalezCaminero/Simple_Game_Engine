/**
 * Original code: automated SDL2 audio test written by Edgar Simo "bobbens"
...
{
    /* Remove a possibly created file from SDL2 disk writer audio driver; ignore errors */
    remove("sdlaudio.raw");
