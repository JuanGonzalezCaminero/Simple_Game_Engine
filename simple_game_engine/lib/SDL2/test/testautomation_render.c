/**
 * Original code: automated SDL2 platform test written by Edgar Simo "bobbens"
...
/**
 * @brief Tests the SDL2 primitives for rendering.
 *
 * \sa
...
/**
 * @brief Tests the SDL2 primitives with alpha for rendering.
 *
 * \sa
 * http://wiki.libsdl.org/SDL_SetRenderDrawColor
